...
<script type="text/javascript"> 
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					url:'jsondata.asp?t=ips',
					datatype: "json",  
					sortname: 'id',
                    sortorder: "desc",
					height: 300,
					colNames:[ 'ID','ip地址','简介' ,'操作'  ],
					colModel:[ 
						{name:'id',index:'id', width:60, sorttype:"int", editable: false},
						{name:'ip',index:'ip',width:90, editable:true,editoptions:{size:"20",maxlength:"30"}},
				...
				//	toppager: true,
					...
					editurl: "updateIps.asp",//nothing is saved
					caption: "ip地址管理", 
					autowidth: true,
