...
<script type="text/javascript"> 
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					url:'jsondata.asp?t=setting',
					datatype: "json",  
					sortname: 'id',
                    sortorder: "desc",
					height: 300,
					colNames:['操作', 'ID','常量名称','简介'  ],
					colModel:[
						...
						{name:'k',index:'k',width:90, editable:true,editoptions:{size:"20",maxlength:"30"}},
						{name:'v',index:'v', width:150,editable: true,editoptions:{size:"20",maxlength:"300"}} 
					], 
				...
				//	toppager: true,
					...
					editurl: "updateSetting.asp",//nothing is saved
					caption: "常量管理", 
					autowidth: true,
