...
<script type="text/javascript"> 
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					url:'jsondata.asp?t=admin',
					datatype: "json",  
					sortname: 'id',
                    sortorder: "desc",
					height: 300,
					colNames:['操作', 'id','用户名','密码', '状态', '登陆时间' ],
					colModel:[
						...
						{name:'psw',index:'psw', width:150,editable: true,editoptions:{size:"20",maxlength:"30"}},
						{name:'state',index:'state', width:70, editable: true,edittype:"checkbox",editoptions: {value:"Yes:No"},unformat: aceSwitch},
						{name:'last',index:'last', width:90, editable: false,edittype:"date",unformat: pickDate} 
					], 
					...
					editurl: "updateUser.asp",//nothing is saved
					caption: "系统用户管理",
					autowidth: true,
